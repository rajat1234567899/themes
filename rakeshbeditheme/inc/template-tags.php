...
if (!function_exists('my_custom_theme_posted_on')) :
    /**
...
if (!function_exists('my_custom_theme_posted_by')) :
    /**
...
if (!function_exists('my_custom_theme_entry_footer')) :
    /**
...
if (!function_exists('my_custom_theme_post_thumbnail')) :
    /**
